        ...
        <div v-else>
            ...
            <div class="p-fluid">
                <form @submit.prevent="handleSubmit(!v$.$invalid)" class="">
                    ...
                    <div class="field">
                        <label for="enhancedSetupFlowOptions">Enhanced Setup Flow</label>
                    ...
                    <div class="field">
                        <label for="enhancedSetupFlowTCUrl">Enhanced Setup Flow Terms and Conditions URL</label>
                    ...
                    <div class="field">
                        <label for="enhancedSetupFlowTCRevision">Enhanced Setup Flow Terms and Conditions Revision</label>
                    ...
                    <div class="field">
                        <label for="enhancedSetupFlowTCDigest">Enhanced Setup Flow Terms and Conditions Digest</label>
                    ...
                    <div class="field">
                        <label for="enhancedSetupFlowTCFileSize">Enhanced Setup Flow Terms and Conditions File Size</label>
                    ...
                    <div class="field">
                        <label for="maintenanceUrl">Maintenance URL</label>
